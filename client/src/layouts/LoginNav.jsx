...
import activityIcon from "../assets/img/activity_icon.png";
    ...
    <>
      <div className="fixed top-0 left-0 right-0 flex items-center justify-between p-3 bg-black z-99">
        <div className="left-side flex items-center">
          <img
            src={activityIcon}
            className="w-16 p-2 bg-green-300 rounded-full mr-3"
          />
          <p className="font-semibold text-2xl text-neutral-50">
            Activity Tracker
          </p>
        </div>
