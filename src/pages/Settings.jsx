...
const Settings = () => {
  ...
  return (
    <div className={`min-h-screen flex ${darkMode ? 'bg-[#121212] text-white' : 'bg-white text-black'}`}>
      <div className={`left-side pl-7 w-3/7 border-r ${darkMode ? 'border-gray-700' : 'border-gray-600'}`}>
          ...
          <div className="top-box flex p-2 justify-between items-center">
            <div className="relative w-20 h-20">
              <svg className="w-full h-full" viewBox="0 0 100 100">
                ...
                <circle cx="50" cy="50" r="40" stroke="white" strokeWidth="8" fill="none" strokeDasharray="251.2" strokeDashoffset="62.8" strokeLinecap="round" className="transition-all duration-500 ease-in-out" />
              </svg>
              <p className="absolute inset-0 flex items-center justify-center text-lg font-bold">75%</p>
            </div>
        ...
        <div className="settings-button mt-8 mr-5">
          <SettingsButton icon={faWandMagicSparkles} title={'Appearances'} description={'Click to Change Into Dark or Light Mode'} onClick={() => setDarkMode(!darkMode)} darkMode={darkMode} />
          <SettingsButton icon={faPerson} title={'Account Settings'} description={'Personal Informations, Email'} darkMode={darkMode} />
          <SettingsButton icon={faLock} title={'Security'} description={'Change Password, 2 Factor Authorization'} darkMode={darkMode} />
        </div>
      </div>
      <div className="right-side w-4/7 pl-7">
        <p className="py-9 font-semibold text-xl">
          Account Settings
          <span className={`block w-full mt-8 border-b-2 ${darkMode ? 'border-gray-700' : 'border-[#323444]'} opacity-50`}></span>
        </p>
        <p className="font-semibold text-xl mb-3">Personal Informations</p>
        <p className={`mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        ...
        <form>
          <div className="inline-name flex gap-4 mb-4">
            <div className="w-80">
              ...
              <input
                ...
                className={`border p-2 rounded-md w-full focus:ring focus:border-blue-500 ${darkMode ? 'bg-gray-900 text-white border-gray-600' : 'border-gray-400'}`}
                required
              />
            </div>
            <div className="w-80">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`border p-2 rounded-md w-164 focus:ring focus:border-blue-500 ${darkMode ? 'bg-gray-900 text-white border-gray-600' : 'border-gray-400'}`}
              required
            />
          </div>
          <div className="mb-4">
