...
const Support = () => {
  return (
    <div className='bg-[#121212] h-screen overflow-y-scroll' style={{ scrollbarWidth: 'none'}}> {/* FIXED REQUIREMENT!!!!!! */}
    {/* <div className='bg-[#121212] min-h-screen overflow-y-scroll scrollbar-none'> */}
        ...
        <div className="middle mt-30">
            <h1 className='mt-4 mb-3 font-bold text-4xl text-neutral-50 text-center'>Getting Started</h1>
            <p className='text-center text-gray-400 font-semibold mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione quasi suscipit id nesciunt placeat aliquam.</p>
            <SupportDropDown 
        ...
        <div className="bottom mt-20">
            <h1 className='mt-4 mb-3 font-bold text-4xl text-neutral-50 text-center'>Track Questions</h1>
            <p className='text-center text-gray-400 font-semibold mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione quasi suscipit id nesciunt placeat aliquam.</p>
            <SupportDropDown 
